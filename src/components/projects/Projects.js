    ...
    <div className='project-section'>
          ...
          <div className="project-card">
            ...
            <div className="project-details">
              ...
              <div style={{fontSize:10+'px' ,paddingLeft: 10+"rem", paddingTop: 10+"rem"}}>
                This project is made for database management course at MUN <br/> 
                and the source code will be available after the submission on 28/11/2024.
              </div>
      ...
      <div className="project bigbull" name="Bigbull">              
          <div className="project-card">
            ...
            <div ref={bigbull} className={window.innerWidth < 1024? "bigbull-slider img-slider": "image-track"} data-mouse-down-at="0" data-prev-percentage= "0" data-visible ={`${bigbullIsVisible? 1 :0}`} draggable="false">
            <div class="arrow">
                <span></span>
                <span></span>
                <span></span>
      ...
      <div className="project" name="CantStop">
          <div className="project-card">
            ...
            <img alt=""  className="image" src="/images/cantstop/png"draggable="false"/>
